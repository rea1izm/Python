...
name = input('Введите свое имя и фамилию с заглавной буквы: ')
email = input('Введите свой email: ')
pattern_name = '^([A_ZА-Я][a-zа-я]+)$'
pattern_email = '^([a-z1-9_]+@[a-z1-9]+\.(ru|org|com))$'

search_name = re.search(pattern_name, name)
if search_name:
	print('Имя и фамилия введены верно!')
else:
	print('Неверно указаны имя и фамилия.')
...
if search_result:
	print('В тексте встречается 2 и более точки подряд.')
else:
	print('Две и более точки подряд в тексте не найдено.')